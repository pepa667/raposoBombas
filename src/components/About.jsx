export function About() {
  return (
    <section id="sobre" className="relative ">
      ...
      <div className="mx-auto max-w-[96svw] md:max-w-[90svw] max-h-fit w-7xl px-1 py-16 sm:px-6 lg:px-8 lg:py-24 ">
        <div className="flex flex-col justify-between scroll-reveal min-h-fit gap-10 px-4 md:px-20 group relative rounded-md [--delay-step:30%] bg-raposo-dark-800  bg-linear-to-t  from-raposo-red-dark to-raposo-red-dark/40 to-raposo-red-darkbg-raposo-red-dark/10 p-6 py-18 shadow-sm transition-all hover:-translate-y-1 hover:border-raposo-red/20 hover:shadow-md overflow-hidden group">
