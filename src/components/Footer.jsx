      ...
      <div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 md:flex-row">
        ...
        <div class="flex items-center gap-2 tracking-widest uppercase">
          ...
          <a
            ...
            class="group border-primary/10 bg-primary/5 text-primary hover:border-primary/40 relative rounded border px-2 py-1 font-black shadow-[0_0_15px_rgba(245,158,11,0.2)] transition-colors duration-300 hover:text-slate-950 hover:shadow-[0_0_20px_rgba(245,158,11,0.2)]"
          >
            <span class="relative z-10">[ PEPA.DEV.br ]</span>
            <span class="bg-primary absolute inset-0 z-0 origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
          </a>
        </div>
      </div>
    </footer>
