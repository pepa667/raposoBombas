...
export function Header() {
  return (
    <header
      id="header"
      className="sticky float-start top-0 min-w-svw border-0 border-b-2 border-slate-500/50 bg-raposo-dark transition-all duration-1000 z-10"
    >
      <div className="mx-auto max-h-25 flex gap-3 md:gap-8 max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8 transition-all duration-700">
        ...
        <div className="">
          <a
            ...
            className="whatsapp-btn group inline-flex items-center gap-0 lg:hover:gap-3.5 rounded-4xl content-evenly lg:rounded-md bg-raposo-red px-4 py-2 text-lg font-bold text-neutral-200 shadow-md transition-all hover:bg-red-950 hover:shadow-lg border-2 border-raposo-red/50 hover:border-raposo-yellow hover:text-raposo-yellow duration-1000"
