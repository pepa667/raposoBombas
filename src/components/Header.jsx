    ...
    <header className="fixed top-0 left-0 z-50 w-full border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4">
        <h1 className="hidden text-2xl font-black tracking-tighter text-white">
          RAPOSO<span className="text-amber-500">BOMBAS</span>
        </h1>
        <Raposo
        ...
        <nav className="hidden gap-8 text-sm font-medium text-zinc-400 md:flex">
          <a href="#sobre" className="transition-colors hover:text-amber-500">
            Sobre Nós
          </a>
          <a
            href="#servicos"
          ...
          <a
            ...
            className="whatsapp-btn rounded-full bg-amber-500 px-5 py-2 font-bold text-zinc-950 transition-all hover:bg-amber-400"
          >
            Agendar Avaliação
          </a>
        </nav>
