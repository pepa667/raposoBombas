      ...
      <div className="mx-auto max-h-25 flex gap-3 md:gap-8 max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8 transition-all duration-700">
        ...
        <div className="">
          <a
            ...
            className="whatsapp-btn h-12 group inline-flex items-center gap-0 lg:hover:gap-3.5  content-evenly bg-raposo-yellow/30 px-4 py-2 text-lg font-bold text-raposo-dark-200 shadow-md transition-all hover:bg-raposo-red-dark hover:shadow-lg border-2 border-raposo-yellow hover:border-raposo-yellow hover:text-raposo-yellow duration-1000"
