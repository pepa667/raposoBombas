...
export function Header() {
  return (
    <header className="sticky top-0  border-0 border-b-2 border-slate-700 bg-raposo-dark transition-none z-10">
      <div className="mx-auto max-h-25 flex gap-3 md:gap-8 max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8 *:transition-all *:duration-700">
        ...
        >
          <div className="absolute bg-linear-to-b from-slate-300/12 to-slfrom-slate-300/4 blur-[2px] size-[calc(100%-1rem)] m-2 inset-ring-8/4 top-0 left-0 rounded-sm "></div>
          <LogoRaposo
